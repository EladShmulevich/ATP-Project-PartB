...
public class Maze implements Serializable {
    ...
    public int hashCode() {
        int sumByte = 0;
        byte[] thisByteArr = this.toByteArray();
        return Arrays.hashCode(thisByteArr);
//        for (byte b : thisByteArr)
//            sumByte += b;
//        return sumByte;
    }
    ...
    public boolean equals(Object other) {
        ...
        Maze m = (Maze) other;
        byte[] otherByteArr = m.toByteArray();
        byte[] thisByteArr = this.toByteArray();
        return (Arrays.equals(otherByteArr, thisByteArr));
    }
}
